...
import { DashboardWidgetRenderer, WidgetCatalogList } from "@/components/dashboards/dashboard-widget-renderer";
  ...
  return (
    <div className="space-y-6">
      <section className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <p className="text-caption text-[var(--text-tertiary)]">Dashboard customizado</p>
          <div className="mt-2 flex flex-wrap items-center gap-3">
            <h2 className="text-2xl font-semibold tracking-[-0.02em]">{dashboard.name}</h2>
            {dashboard.isDefault ? (
          ...
          <p className="mt-2 text-sm text-[var(--text-secondary)]">
            Período: {period.label}. Ordem vertical por slots, sem drag-and-drop.
          </p>
        </div>
